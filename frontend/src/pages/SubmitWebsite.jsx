...
import { Check, Upload, ChevronRight, ChevronLeft, Sparkles, PartyPopper, Loader2, AlertCircle } from 'lucide-react';
import { submitWebsite } from '../services/websiteService';
...
const SubmitWebsite = () => {
    ...
    const nextStep = () => {
        if (step === 1) {
            if (!formData.name || !formData.url || !formData.email || !formData.category) {
        ...
        if (step === 2) {
            if (!formData.shortDescription) {
                setError('Please provide a short description before proceeding.');
                return;
            }
        }
        setError('');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await submitWebsite(submitData);
            if (result.success) {
                setIsSubmitted(true);
            } else {
                setError(result.message || 'Failed to submit website');
            }
        } catch (err) {
                    ...
                    {isSubmitted ? (
                        ...
                        >
                            ...
                            <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6 relative z-10 animate-bounce">
                             ...
                             <h2 className="text-4xl font-bold text-gray-800 mb-4 relative z-10">Submission Successful!</h2>
                            <p className="text-xl text-gray-600 mb-8 relative z-10">
                                Thank you for submitting <strong>{formData.name}</strong>. It is now live on the platform.
                            </p>
                        ...
                        <>
                            ...
                            <Card className="overflow-hidden shadow-2xl border-0 ring-1 ring-gray-100">
                                ...
                                <form onSubmit={handleSubmit} className="min-h-[300px]">
                                    {error && (
                                        <div className="bg-red-50 border border-red-100 text-red-600 px-4 py-3 rounded-xl flex items-start gap-3 text-sm font-medium mb-6">
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        <option value="Crypto Exchanges">Crypto Exchange</option>
                                                        <option value="NFT Marketplaces">NFT Marketplace</option>
                                                        <option value="Crypto Wallets">Crypto Wallet</option>
                                                        <option value="DeFi Platforms">DeFi Platform</option>
                                                        <option value="Blockchain Explorers">Blockchain Explorer</option>
                                                        <option value="Crypto News & Media">Crypto News & Media</option>
                                                        <option value="Learning & Education">Learning & Education</option>
                                                        <option value="Portfolio Trackers">Portfolio Tracker</option>
                                                        ...
                                                        <option value="Staking Platforms">Staking Platforms</option>
                                                    </select>
                                                </div>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        placeholder="Describe your platform in 50-200 characters..."
                                                        maxLength={200}
                                                    />
                                                    <p className="text-right text-xs text-gray-400 mt-1">{formData.shortDescription.length}/200</p>
                                                </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <Button 
                                                        ...
                                                        className="flex-1 h-12 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 border-0 shadow-lg shadow-green-500/30"
                                                    >
                                                        {isSubmitting ? (
