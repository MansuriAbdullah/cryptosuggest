...
import { Search, Menu, X, ChevronRight, Wallet, Sparkles, User, LogOut } from 'lucide-react';
                    ...
                    <div className="hidden lg:flex items-center gap-2 xl:gap-3">
                        ...
                        {isAuthenticated ? (
                            <div className="flex items-center gap-2">
                                <Link to="/profile">
                                    <div className="h-11 w-11 rounded-xl bg-blue-50 flex items-center justify-center text-primary hover:bg-blue-100 transition-colors">
                                        <User className="w-5 h-5" />
                                    </div>
                                </Link>
                                <button
                                    onClick={logout}
                                    className="h-11 w-11 rounded-xl bg-red-50 flex items-center justify-center text-red-500 hover:bg-red-100 transition-colors"
                                    title="Logout"
                                >
                            ...
                            <Link to="/login">
                                <Button variant="outline" className="!h-11 !px-6 text-sm font-bold border-2">
                                    Login
                                </Button>
                            </Link>
                        )}
